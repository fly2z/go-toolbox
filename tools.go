...
const randomStringSource = "abcdefghijklmnopqrstuvxyzABCDEFGHIJKLMNOPQURSVWXYZ0123456789_+"
...
// and potentially an error. If the optional last parameter is set to true, then will not rename
